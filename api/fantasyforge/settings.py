"""
Django settings for fantasyforge project.
...
ROOT_URLCONF = 'fantasyforge.urls'
...
WSGI_APPLICATION = 'fantasyforge.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticated',  # Ensures authentication
    ),
}
